...
from cardtale.visuals.plots.struc_nszones import SeriesNonStationarityZonesPlot
...
class StructuralAnalysis(ReportAnalyser):
    ...
    def __init__(self, data: UVTimeSeries):
        ...
        self.plots = {
            'line_plot': SeriesLinePlot(data=data, name='series_plot'),
            ...
            # 'nsz_plot': SeriesNonStationarityZonesPlot(data=data, name='nsz_plot'),
        }
